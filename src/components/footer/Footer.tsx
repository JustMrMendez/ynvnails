...
function Footer() {
  return (
    <div className="mt-14 grid h-[80vh] w-full place-items-center pt-5">
      <div className="fixed bottom-0 -z-10 mx-auto flex h-[83vh] w-11/12 flex-col justify-center gap-12  md:w-2/3">
