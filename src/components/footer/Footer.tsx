...
function Footer() {
  return (
    ...
    <div className="sticky bottom-0 z-10 mx-auto flex h-screen w-11/12 flex-col justify-center gap-12  md:w-2/3">
      <div className="flex h-2/5 w-full flex-col justify-around rounded-2xl bg-gradient-to-br from-purple-500 to-pink-600 px-2 text-center text-black shadow-lg md:rounded-3xl">
