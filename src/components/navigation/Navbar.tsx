...
function Navbar() {
    ...
    return (
        <>
            <div className="fixed top-2 z-50 my-2 w-11/12 md:w-full">
            ...
            <button
                className={`fixed top-7 right-6 z-[51] flex h-6 w-8 transform cursor-pointer  flex-col justify-between  transition duration-300 ease-in-out lg:hidden ${
