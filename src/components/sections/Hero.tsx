...
function Hero() {
    return (
        <div className="flex h-[50vh] max-w-screen-2xl items-center rounded-b-md bg-gradient-to-br from-purple-500 to-pink-600 px-5 shadow-md shadow-2xl md:h-[70vh] md:w-full md:rounded-2xl">
